...
export const ContentSectionSchema = z.object({
  ...
  code: z
    .string()
    .default('')
    .describe('Code example if applicable, wrapped in <precode> tags. Empty string if no code.'),
});
...
export const StudyNotesSchema = z.object({
  summary: z.string().describe('2-3 paragraph overview of the chapter content'),
  keyPoints: z.array(z.string()).min(1).describe('5-7 main takeaways from the chapter'),
  importantTerms: z.array(ImportantTermSchema).describe('Key terms and their definitions'),
});
