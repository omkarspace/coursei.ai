...
export default function Footer() {
  return (
    <footer
      className="bg-gray-50 dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800"
      role="contentinfo"
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              The open-source learning platform powered by AI. Create courses, quizzes, flashcards,
              and study notes in minutes.
            </p>
